        ...
        if (array_int[i] != 0)
        {
            ...
            if (array_int[i] % 100 >= 10 && array_int[i] % 100 <= 19) result += " " + array_string[i, 2] + " ";
            else switch (array_int[i] % 100)
                {
                    ...
                    case 2: result += " " + array_string[i, 1] + " "; break;
                    case 3: result += " " + array_string[i, 2] + " "; break;
                    case 4: result += " " + array_string[i, 3] + " "; break;
                    case 5: result += " " + array_string[i, 4] + " "; break;
                    case 6: result += " " + array_string[i, 5] + " "; break;
                    case 7: result += " " + array_string[i, 6] + " "; break;
                    case 8: result += " " + array_string[i, 7] + " "; break;
                    case 9: result += " " + array_string[i, 8] + " "; break;
